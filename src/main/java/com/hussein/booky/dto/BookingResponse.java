...
public class BookingResponse {
    ...
    public BookingResponse(Integer id, LocalDateTime appointmentTime, String status,
                           Integer userId, String clientName, String clientEmail,
                           Integer serviceId, String serviceName, Double servicePrice, Integer serviceDuration,
                           Integer businessId, String businessName, String businessLocation) {
        this.id = id;
